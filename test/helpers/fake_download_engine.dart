...
class FakeIDownloadEngine implements IDownloadEngine {
  ...
  Future<void> download({
    ...
    if (shouldThrowOnDownload) {
      throw downloadErrorToThrow ??
          Exception('Simulated download failure for $taskId');
    }
    ...
    if (simulatedDownloadDelay > Duration.zero) {
      ...
      for (var i = 1; i <= steps; i++) {
        ...
        onProgress(DownloadProgress(
          ...
          fileSize: totalBytes,
          speed: (totalBytes / (simulatedDownloadDelay.inMilliseconds / 1000))
              .clamp(0, 100000000),
  ...
  @override
  Future<bool> hasEnoughDiskSpace(
      String targetDirectory, int requiredBytes) async {
