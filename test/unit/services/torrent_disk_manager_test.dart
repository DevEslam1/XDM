...
void main() {
  group('TorrentDiskManager Unit Tests (Phase 2 & 8)', () {
    ...
    test('coalesceWriteBytes scales per DiskIoMode', () {
      ...
      expect(
          TorrentDiskManager.coalesceWriteBytes(DiskIoMode.emmc), 256 * 1024);
    ...
    test('optimalPieceSize scales cleanly with total file bytes', () {
      ...
      expect(
          TorrentDiskManager.optimalPieceSize(500 * 1024 * 1024), 512 * 1024);
      expect(TorrentDiskManager.optimalPieceSize(2 * 1024 * 1024 * 1024),
          1024 * 1024);
      expect(TorrentDiskManager.optimalPieceSize(10 * 1024 * 1024 * 1024),
          2 * 1024 * 1024);
    });
    ...
    test('hasStreamingVideo accurately detects video extensions', () {
      final nonVideo = [
        TorrentFileItem(
            index: 0, name: 'document.pdf', size: 100 * 1024 * 1024),
