...
import 'package:shared_preferences/shared_preferences.dart'; // FIX-P0-1
 // FIX-P0-1
class _DummyAdapter implements HttpClientAdapter { // FIX-P0-1
  @override // FIX-P0-1
  Future<ResponseBody> fetch( // FIX-P0-1
    RequestOptions options, // FIX-P0-1
    Stream<List<int>>? requestStream, // FIX-P0-1
    Future<void>? cancelFuture, // FIX-P0-1
  ) async { // FIX-P0-1
    return ResponseBody( // FIX-P0-1
...
void main() { // FIX-P0-1
 ...
 // FIX-P0-1
  setUp(() async { // FIX-P0-1
    SharedPreferences.setMockInitialValues({}); // FIX-P0-1
    tempDir = await Directory.systemTemp.createTemp('cold_kill_test_'); // FIX-P0-1
    tempFilePath = '${tempDir.path}/download.tmp'; // FIX-P0-1
    localFilePath = '${tempDir.path}/download.bin'; // FIX-P0-1
  }); // FIX-P0-1
 // FIX-P0-1
  tearDown(() async { // FIX-P0-1
    if (await tempDir.exists()) { // FIX-P0-1
      await tempDir.delete(recursive: true); // FIX-P0-1
    } // FIX-P0-1
  }); // FIX-P0-1
 // FIX-P0-1
  test('P0-1: simulates SIGKILL mid-chunk and verifies journal replay recovers within 1MB', () async { // FIX-P0-1
 ...
 // FIX-P0-1
    ...
    final oldState = TransferState( // FIX-P0-1
      totalSize: totalSize, // FIX-P0-1
      threadCount: threadCount, // FIX-P0-1
      url: 'https://example.com/file.zip', // FIX-P0-1
      chunks: [ // FIX-P0-1
        ChunkState(start: 0, end: chunkSize - 1, downloaded: 20 * 1024 * 1024), // FIX-P0-1
        ChunkState(start: chunkSize, end: totalSize - 1, downloaded: 5 * 1024 * 1024), // FIX-P0-1
      ], // FIX-P0-1
    ); // FIX-P0-1
 ...
 // FIX-P0-1
    ...
    await journal.close(); // Simulates fsync flush to disk prior to kill // FIX-P0-1
 // FIX-P0-1
 ...
 // FIX-P0-1
    receivePort.listen((dynamic msg) { // FIX-P0-1
      if (msg is Map) { // FIX-P0-1
        emittedEvents.add(Map<String, dynamic>.from(msg)); // FIX-P0-1
      } // FIX-P0-1
    }); // FIX-P0-1
 // FIX-P0-1
    final cmd = DownloadCommand( // FIX-P0-1
      ...
      supportsResume: false, // Prevents identity check from hitting network // FIX-P0-1
    ); // FIX-P0-1
 // FIX-P0-1
 ...
 // FIX-P0-1
    ...
    final verifyingEvent = emittedEvents.any((e) { // FIX-P0-1
      final data = e['data'] as Map<String, dynamic>?; // FIX-P0-1
      return data != null && data['cycleState'] == CycleState.verifying.name; // FIX-P0-1
    }); // FIX-P0-1
