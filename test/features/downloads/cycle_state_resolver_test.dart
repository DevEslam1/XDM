...
void main() {
  ...
  group('CycleStateResolver LRU Eviction (Sprint 1)', () {
    test('LRU cache retains capacity up to 256 and evicts oldest rather than clearing all', () {
      ...
      final state = CycleStateResolver.resolve(statusMessage: 'Downloading chunk #256');
