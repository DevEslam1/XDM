const Map<String, String> esTranslations = {
  ...
  'browser_load_more_history': 'CARGAR MÁS',
  'browser_tab_crashed': 'Esta pestaña falló inesperadamente',
  'browser_reload_tab': 'Recargar pestaña',
  'browser_load_failed': 'No se pudo cargar la página',
  'browser_unknown_error': 'Error desconocido',
  'browser_try_again': 'Intentar de nuevo',
  'browser_page_taking_long': 'La página tarda mucho en cargar…',
  ...
  'browser_find_in_page': 'Buscar en la página',
  'browser_reader_mode': 'Modo de lectura',
  'browser_page_zoom': 'Zoom de página',
  'browser_share_link': 'Compartir enlace',
  'browser_copy_link': 'Copiar enlace',
  'browser_save_offline': 'Guardar página sin conexión',
  'browser_keyboard_shortcuts': 'Atajos de teclado',
  'browser_recently_closed': 'Pestañas cerradas recientemente',
  'browser_desktop_site': 'Modo escritorio',
