const Map<String, String> arTranslations = {
  ...
  'subscription_subtitle': 'افتح تجربة XDM الكاملة',
  'subscription_free_tier': 'الخطة المجانية',
  'subscription_free_description': 'ميزات محدودة — ترقية للوصول الكامل',
  'subscription_premium': 'مميز',
  'subscription_premium_feature': 'ميزة مميزة',
  'subscription_upgrade_to_unlock': 'ترقية إلى Premium لفتح هذه الميزة',
  'subscription_upgrade_now': 'ترقية الآن',
  'subscription_view_plans': 'عرض الخطط',
  'subscription_choose_plan': 'اختر خطتك',
  'subscription_subscribe': 'اشترك',
  'subscription_subscribe_now': 'اشترك الآن',
  'subscription_manage': 'إدارة',
  'subscription_manage_description':
      'إدارة اشتراكك في App Store أو Play Store.',
  'subscription_restore': 'استعادة المشتريات',
  'subscription_restore_success': 'تمت استعادة المشتريات بنجاح',
  'subscription_restore_failed': 'لم يتم العثور على مشتريات لاستعادتها',
  'subscription_status_active': 'Premium نشط',
  'subscription_status_expired': 'انتهى الاشتراك',
  'subscription_expires': 'ينتهي',
  'subscription_grace_period': 'ستستمر تنزيلاتك حتى نهاية فترة السماح.',
  'subscription_free_limit': 'الخطة المجانية تسمح بـ {0} تنزيلات متزامنة',
  'subscription_max_downloads_reached': 'تم الوصول لحد التنزيلات',
  'subscription_compare_plans': 'مقارنة الخطط',
  'subscription_feature': 'الميزة',
  'subscription_free': 'مجاني',
  'subscription_go_premium': 'احصل على Premium',
  'subscription_paywall_subtitle':
      'افتح تنزيلات غير محدودة ودعم التورنت والمزيد',
  'subscription_unlock_feature': 'فتح هذه الميزة',
  'subscription_terms':
      'تجديد الاشتراك تلقائيًا ما لم يتم الإلغاء قبل 24 ساعة على الأقل من نهاية الفترة الحالية.',
  'subscription_welcome_premium':
      'مرحبًا بك في Premium! استمتع بتنزيلات غير محدودة.',
  'maybe_later': 'لاحقًا',
};
