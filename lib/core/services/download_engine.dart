      ...
      if (!isMultiThread) {
        ...
        if (resolvedFileSize > 0) {
          ...
          threadCount = await _probeOptimalThreads(
            isolatedDio, punyUrl, effectiveThreads, resolvedFileSize,
          );
          debugPrint(
        ...
        if (journalProgress != null && journalProgress.length == threadCount) {
          ...
          debugPrint('[DownloadEngine] Recovered progress from journal: $chunkProgress');
            ...
            futures.add(() async {
              ...
              while (attempts < maxAttempts) {
                ...
                try {
                  ...
                  try {
                    ...
                    try {
                      await for (final chunk in stream) {
                        ...
                        final absolutePosition = start + resumeFrom +
                  ...
                  final delay = (attempts * attempts * 2) +
                      Random().nextInt(3);
