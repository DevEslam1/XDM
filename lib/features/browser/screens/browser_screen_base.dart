...
abstract class _BrowserScreenStateBase extends State<BrowserScreen>
  ...
  // FIX(B5) follow-up: SiteSettingsStore was refactored to instance-scoped
  // members ("multiple stores never share a single global mutable cache"),
  // so the screen keeps one store for all per-host settings lookups.
  final SiteSettingsStore _siteSettingsStore = SiteSettingsStore();
