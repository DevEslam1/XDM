...
class _AddDownloadDialogState extends State<AddDownloadDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final panelBg = classicUi ? (isDark ? const Color(0xFF0F0F16) : const Color(0xFFF1F5F9)) : (isDark ? AppTheme.surface.withValues(alpha: 0.4) : AppTheme.lightSurface.withValues(alpha: 0.4));
